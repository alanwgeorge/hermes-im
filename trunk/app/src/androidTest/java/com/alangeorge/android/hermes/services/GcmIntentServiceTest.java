...
public class GcmIntentServiceTest extends ServiceTestCase<GcmIntentService> {
    ...
    // Tests sending GCM broadcast but test completes before Service is reached.
    // Preserving for possible future use.
    @SuppressWarnings("UnusedDeclaration")
    public void BroadcastHermesGcmMessage() throws Exception {
    ...
    public void testGcmIntentDelivery() throws Exception {
