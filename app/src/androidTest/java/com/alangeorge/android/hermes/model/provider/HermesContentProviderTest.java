...
public class HermesContentProviderTest extends ProviderTestCase2<HermesContentProvider> {
    private static final String TAG = "HermesCntntProviderTest";
    ...
    public void testAttemptNoContactMessageInsert() throws Exception {
        ...
        messageValues.put(DBHelper.MESSAGE_CONTACT_COLUMN_MESSAGE_IS_INBOUND, true);
    ...
    private static class MessagesContactContentObserver extends ContentObserver {
        private static final String TAG = "MssgsCntctCntntObserver";
