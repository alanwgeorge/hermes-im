...
public class DBHelper extends SQLiteOpenHelper {
    ...
    static {
        ...
        MESSAGE_CONTACT_JOIN_PROJECTION_MAP.put(MESSAGE_COLUMN_ID, MESSAGE_PREFIX + "." + MESSAGE_COLUMN_ID + " as " + MESSAGE_COLUMN_ID);
        MESSAGE_CONTACT_JOIN_PROJECTION_MAP.put(MESSAGE_COLUMN_CONTACT_ID, MESSAGE_PREFIX + "." + MESSAGE_COLUMN_CONTACT_ID + " as " + MESSAGE_COLUMN_CONTACT_ID);
        MESSAGE_CONTACT_JOIN_PROJECTION_MAP.put(MESSAGE_COLUMN_MESSAGE_JSON, MESSAGE_PREFIX + "." + MESSAGE_COLUMN_MESSAGE_JSON + " as " + MESSAGE_COLUMN_MESSAGE_JSON);
        MESSAGE_CONTACT_JOIN_PROJECTION_MAP.put(MESSAGE_COLUMN_READ_TIME, MESSAGE_PREFIX + "." + MESSAGE_COLUMN_READ_TIME + " as " + MESSAGE_COLUMN_READ_TIME);
        MESSAGE_CONTACT_JOIN_PROJECTION_MAP.put(MESSAGE_COLUMN_CREATE_TIME, MESSAGE_PREFIX + "." + MESSAGE_COLUMN_CREATE_TIME + " as " + MESSAGE_COLUMN_CREATE_TIME);
        MESSAGE_CONTACT_JOIN_PROJECTION_MAP.put(CONTACT_PREFIX + "_" + CONTACT_PREFIX + CONTACT_COLUMN_ID, CONTACT_PREFIX + "." + CONTACT_COLUMN_ID + " as " + CONTACT_PREFIX + "_" + CONTACT_PREFIX + CONTACT_COLUMN_ID);
        MESSAGE_CONTACT_JOIN_PROJECTION_MAP.put(CONTACT_PREFIX + "_" + CONTACT_COLUMN_NAME, CONTACT_PREFIX + "." + CONTACT_COLUMN_NAME + " as " + CONTACT_PREFIX + "_" + CONTACT_COLUMN_NAME);
        MESSAGE_CONTACT_JOIN_PROJECTION_MAP.put(CONTACT_PREFIX + "_" + CONTACT_COLUMN_PUBLIC_KEY, CONTACT_PREFIX + "." + CONTACT_COLUMN_PUBLIC_KEY + " as " + CONTACT_PREFIX + "_" + CONTACT_COLUMN_PUBLIC_KEY);
        MESSAGE_CONTACT_JOIN_PROJECTION_MAP.put(CONTACT_PREFIX + "_" + CONTACT_COLUMN_GCM_ID, CONTACT_PREFIX + "." + CONTACT_COLUMN_GCM_ID + " as " + CONTACT_PREFIX + "_" + CONTACT_COLUMN_GCM_ID);
        MESSAGE_CONTACT_JOIN_PROJECTION_MAP.put(CONTACT_PREFIX + "_" + CONTACT_COLUMN_CREATE_TIME, CONTACT_PREFIX + "." + CONTACT_COLUMN_CREATE_TIME + " as " + CONTACT_PREFIX + "_" + CONTACT_COLUMN_CREATE_TIME);
    }
    ...
    public static final String[] MESSAGE_CONTACT_ALL_COLUMNS = {
            ...
            MESSAGE_COLUMN_READ_TIME, // 3
            MESSAGE_COLUMN_CREATE_TIME, // 4
            CONTACT_PREFIX + "_" + CONTACT_PREFIX + CONTACT_COLUMN_ID, // 5
            CONTACT_PREFIX + "_" + CONTACT_COLUMN_NAME, // 6
            CONTACT_PREFIX + "_" + CONTACT_COLUMN_PUBLIC_KEY, // 7
            CONTACT_PREFIX + "_" + CONTACT_COLUMN_GCM_ID, // 8
            CONTACT_PREFIX + "_" + CONTACT_COLUMN_CREATE_TIME // 9
